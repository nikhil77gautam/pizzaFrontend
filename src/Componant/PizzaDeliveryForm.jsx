...
const PizzaDeliveryForm = () => {
    ...
    const fetchCartDetails = async () => {
      try {
        const cartRes = await axios.get(
          `https://pizzabackend-0x3r.onrender.com/getcartpizza/${customerId}`,
          {
  ...
  const handleAddressChange = (e) => {
    const selectedAddress = Userinfo.address.find(
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const selectedAddress = Userinfo.address.find(
        (addr) => addr._id === formData.addressId
      );
      ...
      await axios.post(
        "https://pizzabackend-0x3r.onrender.com/placeOrder",
        orderData,
        {
          headers: { Authorization: localStorage.getItem("authToken") },
        }
    ...
    >
      ...
      <div className="bg-gray-200 pt-5 pb-20 mx-60 border shadow-inner shadow-black rounded-2xl ">
        ...
        <form
          ...
          className="max-w-lg mx-auto p-8 bg-white rounded-lg shadow-2xl "
        >
